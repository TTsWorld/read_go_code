...
// This is a bootstrap copy of /Users/litiantian/code/m_code/read_go_code/go_source/go/src/math/big/int.go

//line /Users/litiantian/code/m_code/read_go_code/go_source/go/src/math/big/int.go:1
...
// and act like interface{} other character that is not a valid digit.
//
...
func (z *Int) lehmerGCD(x, y, a, b *Int) *Int {
	...
	for len(B.abs) > 1 {
		...
		if v0 != 0 {
			...
			// Single-digit calculations failed to simulate interface{} quotients.
...
//   == u^(p+1)          mod p
//   == u^2              mod p
// to calculate the square root of interface{} quadratic residue mod p quickly for 3
// mod 4 primes.
...
// to calculate the square root of interface{} quadratic residue mod p quickly for 5
// mod 8 primes.
...
// root of a quadratic residue modulo interface{} prime.
