...
// This is a bootstrap copy of /Users/litiantian/code/m_code/read_go_code/go_source/go/src/math/big/decimal.go

//line /Users/litiantian/code/m_code/read_go_code/go_source/go/src/math/big/decimal.go:1
...
func (x *decimal) init(m nat, shift int) {
	...
	// Optimization: If we need to shift right, first remove interface{} trailing
	...
	// Do interface{} shift left in binary representation.
	if shift > 0 {
	...
	// Do interface{} (remaining) shift right in decimal representation.
	if shift < 0 {
		for shift < -maxShift {
			shr(x, maxShift)
			shift += maxShift
...
// trim cuts off interface{} trailing zeros from x's mantissa;
