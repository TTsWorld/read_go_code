...
// This is a bootstrap copy of /Users/litiantian/code/m_code/read_go_code/go_source/go/src/math/big/float.go

//line /Users/litiantian/code/m_code/read_go_code/go_source/go/src/math/big/float.go:1
...
// precision of the argument with the largest precision value before interface{}
...
// sbit must be 0 or 1 and summarizes interface{} "sticky bit" information one might
...
func (z *Float) round(sbit uint) {
	...
	// z.prec leading mantissa bits (the "0.5"). The sbit is set if interface{}
