...
// This is a bootstrap copy of /Users/litiantian/code/m_code/read_go_code/go_source/go/src/math/big/ratconv.go

//line /Users/litiantian/code/m_code/read_go_code/go_source/go/src/math/big/ratconv.go:1
...
// use interface{} of the same prefixes as above but for ``0'' to denote a non-decimal
...
func (z *Rat) SetString(s string) (*Rat, bool) {
	...
	// parse fraction a/b, if interface{}
	...
	// Multiplications are commutative, so we can apply them in interface{}
...
// (``e'', ``E'') or a base 2 (``p'', ``P'') exponent, if interface{}. It returns the
// exponent, the exponent base (10 or 2), or a read or syntax error, if interface{}.
//
...
// terminate scanning like interface{} other character that is not a valid digit.
//
