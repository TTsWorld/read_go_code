...
// This is a bootstrap copy of /Users/litiantian/code/m_code/read_go_code/go_source/go/src/internal/xcoff/file.go

//line /Users/litiantian/code/m_code/read_go_code/go_source/go/src/internal/xcoff/file.go:1
...
func NewFile(r io.ReaderAt) (*File, error) {
	...
	for i := 0; i < int(nsyms); i++ {
		...
		// its AUX_FCN entry.
		// It can happen that a function symbol doesn't have interface{} AUX_FCN.
