...
// This is a bootstrap copy of /Users/litiantian/code/m_code/read_go_code/go_source/go/src/internal/buildcfg/exp.go

//line /Users/litiantian/code/m_code/read_go_code/go_source/go/src/internal/buildcfg/exp.go:1
...
// configuration and interface{} variation from this is an experiment.
...
func ParseGOEXPERIMENT(goos, goarch, goexp string) (flags, baseline goexperiment.Flags, err error) {
	...
	// Pick up interface{} changes to the baseline configuration from the
	...
	if goexp != "" {
		...
		for _, f := range strings.Split(goexp, ",") {
			...
			if f == "none" {
				...
				// to build with interface{} experiment flags.
