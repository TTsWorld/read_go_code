...
// This is a bootstrap copy of /Users/litiantian/code/m_code/read_go_code/go_source/go/src/compress/flate/deflatefast.go

//line /Users/litiantian/code/m_code/read_go_code/go_source/go/src/compress/flate/deflatefast.go:1
...
func (e *deflateFast) encode(dst []token, src []byte) []token {
	...
	for {
		...
		for {
			// Invariant: we have a 4-byte match at s, and no need to emit interface{}
...
func (e *deflateFast) shiftOffsets() {
	...
	for i := range e.table[:] {
		...
		if v < 0 {
			...
			// interface{} negative offsets at 0.
			v = 0
		}
		e.table[i].offset = v
	}
