...
// This is a bootstrap copy of /Users/litiantian/code/m_code/read_go_code/go_source/go/src/compress/flate/deflate.go

//line /Users/litiantian/code/m_code/read_go_code/go_source/go/src/compress/flate/deflate.go:1
...
const (
	...
	// RFC 1951 compliant. That is, interface{} valid DEFLATE decompressor will
...
Loop:
	for {
		...
		if lookahead < minMatchLength+maxMatchLength {
			...
			if lookahead == 0 {
				// Flush current output block if interface{}.
				if d.byteAvailable {
...
// (NoCompression) does not attempt interface{} compression; it only adds the
...
// interface{} compressed output. The compressed data written to w
...
// Flush flushes interface{} pending data to the underlying writer.
