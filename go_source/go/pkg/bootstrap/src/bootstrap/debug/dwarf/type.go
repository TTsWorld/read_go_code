...
// This is a bootstrap copy of /Users/litiantian/code/m_code/read_go_code/go_source/go/src/debug/dwarf/type.go

//line /Users/litiantian/code/m_code/read_go_code/go_source/go/src/debug/dwarf/type.go:1
...
// A Type conventionally represents a pointer to interface{} of the
...
func (d *Data) readType(name string, r typeReader, off Offset, typeCache map[Offset]Type, fixups *typeFixer) (Type, error) {
	...
	case TagEnumerationType:
		...
		// Attributes:
		//	AttrName: enum name if interface{}
	...
	case TagSubroutineType:
		...
		// Attributes:
		//	AttrType: type of return value if interface{}
