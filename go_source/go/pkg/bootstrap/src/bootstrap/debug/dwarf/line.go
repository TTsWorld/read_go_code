...
// This is a bootstrap copy of /Users/litiantian/code/m_code/read_go_code/go_source/go/src/debug/dwarf/line.go

//line /Users/litiantian/code/m_code/read_go_code/go_source/go/src/debug/dwarf/line.go:1
...
type LineEntry struct {
	...
	// reference interface{} individual operation within the instruction
	// stream.
	OpIndex int
	...
	// 0 if these instructions cannot be attributed to interface{} source
	// line.
	Line int
...
// seek PC is not covered by interface{} entry in the line table.
...
//
// If pc is not covered by interface{} entry in this line table, SeekPC
...
// path, if interface{}. path == drive + rest
