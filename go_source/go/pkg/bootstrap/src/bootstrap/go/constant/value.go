...
// This is a bootstrap copy of /Users/litiantian/code/m_code/read_go_code/go_source/go/src/go/constant/value.go

//line /Users/litiantian/code/m_code/read_go_code/go_source/go/src/go/constant/value.go:1
...
// is represented as a floatVal, interface{} subsequent results remain floatVals (unless
...
func ToInt(x Value) Value {
	...
	case floatVal:
		...
		// allow interface{} value that would also be permissible as a fraction.)
		if smallFloat(x.val) {
			i := newInt()
