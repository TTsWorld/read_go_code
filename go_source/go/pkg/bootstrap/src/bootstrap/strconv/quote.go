...
// This is a bootstrap copy of /Users/litiantian/code/m_code/read_go_code/go_source/go/src/strconv/quote.go

//line /Users/litiantian/code/m_code/read_go_code/go_source/go/src/strconv/quote.go:1
...
// returning the parsed prefix, the remaining suffix, and interface{} parse errors.
...
func unquote(in string, unescape bool) (out, rem string, err error) {
	...
	case '"', '\'':
		// Handle quoted strings without interface{} escape sequences.
		...
		for len(in) > 0 && in[0] != quote {
			...
			// rejecting interface{} unescaped newline characters which are invalid.
