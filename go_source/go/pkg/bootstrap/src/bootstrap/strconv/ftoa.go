...
// This is a bootstrap copy of /Users/litiantian/code/m_code/read_go_code/go_source/go/src/strconv/ftoa.go

//line /Users/litiantian/code/m_code/read_go_code/go_source/go/src/strconv/ftoa.go:1
...
func roundShortest(d *decimal, mant uint64, exp int, flt *floatInfo) {
	...
	// Compute upper and lower such that interface{} decimal number
...
func fmtX(dst []byte, prec int, fmt byte, neg bool, mant uint64, exp int, flt *floatInfo) []byte {
	...
	// Shift digits so leading 1 (if interface{}) is at bit 1<<60.
